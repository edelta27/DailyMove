...
object ExerciseRepository {
    ...
    val exercises = listOf(
        ...
        Exercise(
            id = 1,
            name = "Przysiad",
            description = "Stań prosto, stopy na szerokość bioder. Zrób powolny przysiad do poziomu kolan i wróć do góry. Pamiętaj, aby  kolana nie rozchylały się za mocno ani do zewnątrz ani do wewnątrz.",
        ...
        Exercise(
            id = 2,
            name = "Pajac",
            description = "Podskocz, rozkładając nogi i unosząc ręce nad głowę. Natępnie wróć w podskoku do początkowej pozycji.",
        ...
        Exercise(
            ...
            description = "Stań prosto, podnieś ręce na wysokość wzroku, spleć luźno palce i poruszaj nadgarstki w różnym kierunku. Krążenie kostek, stań luźno na jednej nodze a drugą trzymaj lekko nad ziemią ale palce mają leżeć na ziemi, zrób krążenie kostki kilka razy w prawo i kilka razy w lewo, zmień stronę. ",
        ...
        Exercise(
            id = 17,
            name = "Skłon do nogi",
            description = "Usiądź wygodnie na ziemi, jedna noga wyprostowana a druga zgięta w wygodny sposób. Nic na siłę, wyprostuj plecy i nie zaokrąglaj ich, przez całe ćwiczenie plecy wyprostowane! Zrób skon do wyprostowanej nogi z zamiarem dotknięcia stóp. Zmień stronę. ",
        ...
        Exercise(
            ...
            description = "Stań prosto, stopy razem. Zrób duży krok do przodu, zegnij kolano tak, aby nie dotykać podłogi i wróć. Staraj się trzymać równowagę. Zmień stronę. To ćwiczenie można robić też w tył – Spróbuj!",
            muscleGroups = listOf("biodra", "uda", "łydki", "kręgosłup"),
            funFact = "Wykroki są lepszą alternatywą niż klasyczne przysiady, ponieważ mniej obciążają kręgosłup.",
            imageFront = 0,
            imageBack = 0,
